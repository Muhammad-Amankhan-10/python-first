# -----------------------------
# Simple OOP Banking System (FIXED)
# -----------------------------
...
def save_terminal_message(text):
    with open("terminal_log.txt", "a", encoding="utf-8") as file:
        file.write(text + "\n")
...
class BankSystem:
    ...
    def create_account(self):
        ...
        save_terminal_message(f"Account type (normal/saving): {acc_type}")
        ...
        save_terminal_message("✅ Account created successfully!")
